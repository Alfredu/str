...
/*******form Compass.ino file*********/
void altIMU::Compass_Heading()
{
  float MAG_X;
  float MAG_Y;
  float cos_roll;
...
/************from file I2C.ino******************/
void altIMU::I2C_Init()
{
  Wire.begin();
}

void altIMU::Gyro_Init()
{
#ifdef IMU_V5
...
/******************from file Vector.ino***********************/
//Computes the dot product of two vectors
float altIMU::Vector_Dot_Product(float vector1[3],float vector2[3])
{
  float op=0;
...
void altIMU::Vector_Cross_Product(float vectorOut[3], float v1[3],float v2[3])
{
...
void altIMU::Vector_Scale(float vectorOut[3],float vectorIn[3], float scale2)
{
  for(int c=0; c<3; c++)
  {
...
void altIMU::Vector_Add(float vectorOut[3],float vectorIn1[3], float vectorIn2[3])
{
  for(int c=0; c<3; c++)
  {
...
/***********************from file matrix.ino*********************************/
//Multiply two 3x3 matrixs. This function developed by Jordi can be easily adapted to multiple n*n matrix's. (Pero me da flojera!). 
void altIMU::Matrix_Multiply(float a[3][3], float b[3][3], float mat[3][3])
{
  for(int x = 0; x < 3; x++)
  {
    for(int y = 0; y < 3; y++)
...
float altIMU::getAngleAroundYAxis() {
  readValue();
