 ...
 *  from our neighbous with IP 192.168.1.2 using EthernetUDP
 */

byte myMAC[] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x04 };
IPAddress myIP(192, 168, 1, 4);
IPAddress destIP(192, 168, 1, 2); //IP of our neighbour
...
void loop() {
  ...
  if(packetSize)
  {
    ...
    if (remote[3]=2) { //we check if it's our neighbour's IP address
